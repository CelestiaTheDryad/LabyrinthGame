...
public class Tile {
    ...
    /**
     * setPlayer - sets whether a player is on a tile
     * @param playerIndex   the player being changed
     * @param isPresent     tells whether the player is there
     */
    public void setPlayer(int playerIndex, boolean isPresent) {
        playersPresent[playerIndex] = isPresent;
    }//setPlayer
